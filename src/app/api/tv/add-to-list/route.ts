...
export async function POST(request: NextRequest) {
  ...
  const titleType = (formData.get("title_type")?.toString() ?? "movie") as "movie" | "series";
  ...
  await supabase.from("list_items").insert({ list_id: listId, title_id: titleId, title_type: titleType });
