...
Title tiles (where the user is authenticated) and the title detail page SHALL show Eye (Watching) and Finished controls that toggle status and reflect the current state.
